...
// MediatR
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(BankMore.ContaCorrente.Application.Commands.CadastrarContaCorrenteCommand).Assembly));
